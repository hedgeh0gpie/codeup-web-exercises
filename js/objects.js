(function() {
    ...
    function hebOffer(shopper) {
        if (shopper.amount > 200) {
            console.log(shopper.name + " qualifies for a 12% discount!");
            console.log("The amount before discount is " + shopper.amount);
            console.log(shopper.name + " only needs to pay " + (shopper.amount * 0.88) + " after discount!");
        } else {
            console.log("No discounts for budget-minded folks! " + shopper.name + " must pay " + shopper.amount);
        }
    }
